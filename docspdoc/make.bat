...
echo.
pdoc -o ..\docspdoc\build -d google --no-show-source --no-math --no-mermaid --search -t ..\docspdoc\templates\darkmode __init__ firmware/soundtouchfirmware.py firmware/soundtouchfirmwareproduct.py firmware/soundtouchfirmwarerelease.py models/addstation.py models/audiodspcontrols.py models/audioproducttonecontrols.py models/audiospeakerattributeandsetting.py models/balance.py models/bass.py models/basscapabilities.py models/bluetoothinfo.py models/capabilities.py models/clockconfig.py models/clocktime.py models/contentitem.py models/controllevelinfo.py models/dspmonostereoitem.py models/infonetworkconfig.py models/mediaserver.py models/mediaserverlist.py models/musicserviceaccount.py models/navigate.py models/navigateitem.py models/navigateresponse.py models/networkinfo.py models/networkinfointerface.py models/networkstatus.py models/networkstatusinterface.py models/nowplayingstatus.py models/performwirelesssitesurveyresponse.py models/playinfo.py models/powermanagement.py models/preset.py models/presetlist.py models/productcechdmicontrol.py models/producthdmiassignmentcontrols.py models/rebroadcastlatencymode.py models/recent.py models/recentlist.py models/removestation.py models/searchresult.py models/searchstation.py models/searchstationartists.py models/searchstationresults.py models/searchstationsongs.py models/service.py models/serviceAvailability.py models/simpleconfig.py models/softwareupdatecheckresponse.py models/softwareupdatequeryresponse.py models/soundtouchconfigurationstatus.py models/sourceitem.py models/sourcelist.py models/speakerattributeandsetting.py models/surveyresultitem.py models/systemtimeout.py models/trackinfo.py models/volume.py models/wirelessprofile.py models/zone.py models/zonemember.py uri/soundtouchnodes.py uri/soundtouchuri.py uri/soundtouchuriscopes.py uri/soundtouchuritypes.py ws/soundtouchwebsocket.py bstappmessages.py bstconst.py bstutils.py soundtouchaudiomodes.py soundtouchclient.py soundtouchdevice.py soundtouchdevicecomponent.py soundtouchdiscovery.py soundtoucherror.py soundtouchexception.py soundtouchhdmicecmodes.py soundtouchitemtypes.py soundtouchkeys.py soundtouchmenutypes.py soundtouchmessage.py soundtouchmodelrequest.py soundtouchnotifycategorys.py soundtouchsortorders.py soundtouchsources.py soundtouchwarning.py
