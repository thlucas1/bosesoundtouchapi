...
echo.
pdoc -o ..\docspdoc\build -d google --no-show-source --no-math --no-mermaid --search -t ..\docspdoc\templates\darkmode __init__ firmware/soundtouchfirmware.py firmware/soundtouchfirmwareproduct.py firmware/soundtouchfirmwarerelease.py models/audiodspcontrols.py models/audioproducttonecontrol.py models/audioproducttonecontrols.py models/balance.py models/bass.py models/basscapabilities.py models/bluetoothinfo.py models/capabilities.py models/clockconfig.py models/clocktime.py models/contentitem.py models/dspmonostereoitem.py models/infonetworkconfig.py models/mediaserver.py models/mediaserverlist.py models/musicserviceaccount.py models/networkinfo.py models/networkinfointerface.py models/networkstatus.py models/networkstatusinterface.py models/powermanagement.py models/preset.py models/presetlist.py models/productcechdmicontrol.py models/producthdmiassignmentcontrols.py models/rebroadcastlatencymode.py models/recent.py models/recentlist.py models/simpleconfig.py models/sourceitem.py models/sourcelist.py models/nowplayingstatus.py models/systemtimeout.py models/volume.py models/wirelessprofile.py models/zone.py models/zonemember.py uri/soundtouchnodes.py uri/soundtouchuri.py uri/soundtouchuriscopes.py uri/soundtouchuritypes.py ws/soundtouchwebsocket.py bstappmessages.py bstconst.py bstutils.py soundtouchclient.py soundtouchdevice.py soundtouchdevicecomponent.py soundtoucherror.py soundtouchexception.py soundtouchkeys.py soundtouchmessage.py soundtouchmodelrequest.py soundtouchnotifycategorys.py soundtouchsources.py soundtouchwarning.py
